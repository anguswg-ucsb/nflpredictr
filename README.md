...
The `nflpredictr` R package provides a lightweight R package that
provides predictions for upcoming (and past) NFL games. `nflpredictr`
provides four main things:

1.  Retrieves new data to use an inputs into a [ML model trained to
